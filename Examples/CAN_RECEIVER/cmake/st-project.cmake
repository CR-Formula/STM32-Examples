...
# BASED ON /Users/troypowers/STM32CubeIDE/workspace_1.13.1/CAN_RECEIVER
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32H743ZITX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32H743ZITX_FLASH.ld>"
)
