...
ALIGN_32BYTES (static uint16_t adcResultsDMA[ADC_CONVERTED_DATA_BUFFER_SIZE]);
int channelCount = 1;
...
//  SCB_InvalidateDCache_by_Addr((uint32_t *) &adcResultsDMA[0], ADC_CONVERTED_DATA_BUFFER_SIZE);
//}
