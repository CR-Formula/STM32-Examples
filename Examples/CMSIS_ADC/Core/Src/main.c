...
/* Definitions for Read_ADC */
osThreadId_t Read_ADCHandle;
const osThreadAttr_t Read_ADC_attributes = {
  .name = "Read_ADC",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of Read_ADC */
  Read_ADCHandle = osThreadNew(ADC_Read, NULL, &Read_ADC_attributes);

  /* creation of LED_Blink */
  LED_BlinkHandle = osThreadNew(Blink, NULL, &LED_Blink_attributes);
...
/**
  * @brief  Function implementing the Read_ADC thread.
