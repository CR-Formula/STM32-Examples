...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Main program for CR-28 Telemetry System
  ******************************************************************************
  */
...
/* USER CODE BEGIN PV */
uint16_t adcBuffer[ADC_BUFFER_SIZE]; // Buffer to hold the ADC Results
volatile int adcConvFlag = 0; // DMA Conversion flag for Analog Converters
