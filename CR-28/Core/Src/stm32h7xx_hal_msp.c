...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(GPIOC, ADC_10B_Pin|ADC_11B_Pin|ADC_4B_Pin|ADC_8B_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_16B_Pin|ADC_17B_Pin|ADC_14B_Pin|ADC_15B_Pin
                          |ADC_18B_Pin|ADC_19B_Pin|ADC_3B_Pin|ADC_7B_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC_9B_Pin|ADC_5B_Pin);
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  /* USER CODE END FDCAN3_MspDeInit 0 */
    ...
    PF7     ------> FDCAN3_TX
    */
    HAL_GPIO_DeInit(GPIOF, CAN3_RX_Pin|CAN3_TX_Pin);
